...
(check-expect (chart empty) (square 0 "solid" "white"))
(check-expect (chart (cons (make-school "S1" 8000) empty))
              (beside/align "bottom" (overlay/align "center" "bottom" (rotate -90 (text "S1" FONT-SIZE FONT-COLOR))
                                                       (rectangle BAR-WIDTH (* 8000 Y-SCALE)  "outline" "black")
                                                       (rectangle BAR-WIDTH (* 8000 Y-SCALE) "solid" BAR-COLOR ))
                                      (square 0 "solid" "white")))
...
;(define (make-bar a) (square 0 "solid" "white"))

; <Use template from> 
(define (make-bar s)  
  (overlay/align "center" "bottom" (rotate -90 (text (school-name s) FONT-SIZE FONT-COLOR))
